        ...
        <div className="space-y-6 max-w-4xl">
            <div className="flex items-center gap-4">
                ...
                <h2 className="text-2xl font-bold tracking-tight">
                    {initialData ? `Edit Delivery ${initialData.id}` : "New Delivery"}
                </h2>
            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <FormField
                                ...
                                render={({ field }: { field: any }) => (
                                    <FormItem>
                                        <FormLabel>Source Reference (SO)</FormLabel>
                                        <FormControl>
                                            <Input placeholder="SO-2023-100" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription>Products designated for delivery</CardDescription>
                            </div>
