...
const statusConfig: Record<Status, { label: string; variant: string; className: string }> = {
  ...
  waiting: { label: 'Waiting', variant: 'secondary', className: 'bg-amber-500/15 text-amber-600 dark:text-amber-400 border-amber-500/20' },
  ready: { label: 'Ready', variant: 'default', className: 'bg-indigo-500/15 text-indigo-600 dark:text-indigo-400 border-indigo-500/20' },
